...
(function( $, window, document, undefined ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var filter = $('<div/>', {
			...
			.append( $('<label class="wpsp-label"/>' ).append( str ) );
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var div = $('<div><label class="wpsp-label"/></div>').addClass( classes.sLength );
...
$.extend( true, DataTable.defaults, {
	dom:
		"<'wpsp-row'<'wpsp-col-sm-6'l><'wpsp-col-sm-6'f>>" +
		"<'wpsp-row'<'wpsp-col-sm-12'tr>>" +
		"<'wpsp-row'<'wpsp-col-sm-5'i><'wpsp-col-sm-7'p>>",
	renderer: 'bootstrap'
} );
...
$.extend( DataTable.ext.classes, {
	...
	sFilterInput:  "wpsp-form-control wpsp-input-sm",
	sLengthSelect: "wpsp-form-control wpsp-input-sm",
